  ...
  const checkCode = (val: string) => {
    ...
    if (trimmed === ADMIN_CODE) {
      ...
      if (userEmail) {
        ...
        // On ne définit la date de début que si elle n'existe pas déjà pour ce code

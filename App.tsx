...
const STRINGS = {
  FR: {
    ...
    disclaimer: "Attention : Ces résultats sont basés sur une analyse IA. Le jeu comporte des risques. Ne pariez que ce que vous pouvez vous permettre de perdre."
  },
  EN: {
  ...
  return (
    <HashRouter>
      <div className="min-h-screen bg-[#020617] text-slate-100 selection:bg-orange-500/30">
        ...
        <nav className="fixed bottom-4 left-8 right-8 bg-[#0b1121]/90 backdrop-blur-3xl border border-white/5 rounded-full py-2 px-6 flex items-center justify-around z-50 shadow-2xl">
          <Link to="/" className="flex flex-col items-center gap-1 py-1 text-slate-500 hover:text-orange-400 transition-colors">
            <LayoutGrid size={22} /><span className="text-[8px] font-black uppercase tracking-tighter">PRONOS</span>
          </Link>
          <Link to="/vip" className="flex flex-col items-center group relative">
            <div className="bg-orange-500 p-3.5 rounded-full -mt-10 border-[6px] border-[#020617] shadow-2xl group-hover:scale-110 transition-transform">
              <Crown size={22} className="text-slate-950" />
            </div>
            <span className="text-[8px] font-black uppercase tracking-tighter text-orange-500 mt-0.5 italic">VIP</span>
          </Link>
          <Link to="/settings" className="flex flex-col items-center gap-1 py-1 text-slate-500 hover:text-orange-400 transition-colors">
            <Settings size={22} /><span className="text-[8px] font-black uppercase tracking-tighter">COMPTE</span>
          </Link>
        </nav>
      </div>
    </HashRouter>
